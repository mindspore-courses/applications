...
def back_project(coords, origin, voxel_size, feats, kr_cam):
    '''
    ...
    :param kr_cam: projection matrix
    ...
    for batch in range(bs):
        ...
        # remove nan
        features[not mask.unsqueeze(1).expand(-1, c, -1)] = 0
        im_z[not mask] = 0
