...
def infer_moco(net, memory_data_loader, test_data_loader, args):
    """
    Infer for image
...
def main():
    """MoCo infer."""
    args = parse_args()
    memory_data, test_data = create_dataset(args.dataset)[1], create_dataset(args.dataset)[2]
    ...
    mindspore.load_param_into_net(models, param_dict)
    infer_moco(models.encoder_q, memory_data, test_data, args)
